...
const container = ".tagcloud",
    texts = ["Python", "JavaScript", "Django", "Bootstrap", "Sql", "Bash", "DRF", "JQuery", "PostgreSQL", "SQLite", "Git", "React", "GitHub", "AWS", "HTML5", "CSS", " REST APIs", "Canva", "Firebase", "NGINX", "Payment Integration"],
    options = {
